                    ...
                    <div class="container-fluid">
                         <div class="card">
                             <div class="card-header" style="color: mediumslateblue;font-size: 4em ;font-style: oblique ">
                                        <strong>ENREGISTREMENT</strong> agent
                                    </div>
                             <form action="" method="post" class="">
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>Nom</strong></label>
                                                <input type="text" id="nf-libelle" name="lib" placeholder="saisir de nom" class="form-control">
                                               
                                            </div>
                                        
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>Prenom</strong></label>
                                                <input type="text" id="nf-libelle" name="lib" placeholder="saisir de prenom" class="form-control">
                                               
                                            </div>
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>adresse</strong></label>
                                                <input type="text" id="nf-libelle" name="lib" placeholder="saisir d'adresse" class="form-control">
                                               
                                            </div>
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>contact</strong></label>
                                                <input type="text" id="nf-libelle" name="lib" placeholder="saisir de contact" class="form-control">
