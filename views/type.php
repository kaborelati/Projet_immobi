                    ...
                    <div class="container-fluid">
                         <div class="card">
                             <div class="card-header" style="color: turquoise;font-size: 4em ; ">
                                        <strong>ENREGISTREMENT</strong> type maison
                                    </div>
                             <form action="http://localhost/Projet_immobi/router.php?c=type&m=ajout" method="POST" class="">
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>Libelle</strong></label>
                                                <input type="text" id="nf-libelle" name="lib" placeholder="saisir type maison" class="form-control">
