            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                         <div class="card">
                             <div class="card-header" style="color: #003eff ;font-size: 4em ;font-style: oblique ">
                                        <strong>Maison</strong> en location
                                    </div>
                             <form action="" method="post" class="">
                                    <div class="card-body card-block">
                                        ...
                                        <div class="col-12 col-md-12"style="font-style: italic;font-size: xx-large">
                                           <label for="nf-libelle" class=" form-control-label"><strong>client</strong></label>

                                                    <select name="selectLg" id="selectLg" class="form-control-label form-control">
                                        ...
                                        <div class="col-12 col-md-12"style="font-style: italic;font-size: xx-large">
                                           <label for="nf-libelle" class=" form-control-label"><strong>agent</strong></label>
                                        ...
                                        <div class="col-12 col-md-12"style="font-style: italic;font-size: xx-large">
                                           <label for="nf-libelle" class=" form-control-label"><strong>maison</strong></label>
                                        ...
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>date</strong></label>
                                                <input type="date" id="nf-libelle" name="lib" placeholder="date de location" class="form-control">
                                               
                                            </div>
                                        <div class="form-group" style="font-style: italic;font-size: xx-large">
                                            <label for="nf-libelle" class=" form-control-label"><strong>etat</strong></label>
                                                <input type="text" id="nf-libelle" name="lib" placeholder="" class="form-control">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="reset" class="btn btn-danger btn-primary">
